        ...
        <MapProvider boardState={boardState} thisPlayerState={thisPlayerState}>
            <div>
                ...
                <PopupManager
                    ...
                    cardsPopupProps={getCardsPopupProps(doPlayCards, gameState, cardState, cardMove, dispatchCardMove, gameState.turn % playersState.players.length === thisPlayerState.index)}
